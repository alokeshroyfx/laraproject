                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <i class="md md-settings-power">Logout</i></a>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('pos') }}" class="waves-effect "><i class="md md-view-list"></i><span class=""><b> POS</b> </span></a>
                            </li>
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-view-list"></i><span> Customer </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-view-list"></i><span> Suppliers </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-view-list"></i><span>Sales history</span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('sales.today') }}">Today Sales</a></li>  
                                </ul>
                            </li>                                                           
                            <li class="has_sub">
